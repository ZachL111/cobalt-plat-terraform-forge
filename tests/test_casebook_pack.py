"""Regression checks for the cobalt-plat-terraform-forge casebook."""
...
from casebook.harness import assert_expected, cobalt_plat_terraform_forge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(cobalt_plat_terraform_forge_summary(), assert_expected())
