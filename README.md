...
cobalt-plat-terraform-forge is a Java project for platform engineering. It focuses on this technical goal: Package a Java local lab for terraform analysis with log and snapshot fixtures, replay consistency checks, and documented operating limits.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 180, risk penalty 7, latency penalty 4, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
